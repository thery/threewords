...
Direct links from each paper3 object to its Rocq definition/theorem. This
table is generated by `scripts/gen_code_links.py`, which relocates the links
when the sources move. Run it after editing `code/coq/`:

```shell
python3 scripts/gen_code_links.py           # rewrite the table
python3 scripts/gen_code_links.py --check    # CI: fail if stale
```

To keep it automatic, install the provided pre-commit hook, which regenerates
the table whenever a committed change touches `code/coq/*.v`:
...
| paper3 | Rocq | file |
|--------|------|------|
| Def. 1 — P-nonoverlapping | [`Pnonoverlap`](https://github.com/thery/threewords/blob/main/code/coq/Nonoverlap.v#L84) | `Nonoverlap.v:84` |
| Def. 2 — F-nonoverlapping | [`Fnonoverlap_aux`](https://github.com/thery/threewords/blob/main/code/coq/Nonoverlap.v#L324) | `Nonoverlap.v:324` |
| Def. 3 — nonoverlap (wIZ) | [`Fnonoverlap`](https://github.com/thery/threewords/blob/main/code/coq/Nonoverlap.v#L338) | `Nonoverlap.v:338` |
| Def. 5 — triple word | [`isTW`](https://github.com/thery/threewords/blob/main/code/coq/TWR.v#L63) | `TWR.v:63` |
| Alg. 1 — Fast2Sum | [`Fast2Sum_correct_aux`](https://github.com/thery/threewords/blob/main/code/coq/Fast2Sum_robust_flx.v#L381) | `Fast2Sum_robust_flx.v:381` |
| Alg. 2 — 2Sum | [`TwoSum`](https://github.com/thery/threewords/blob/main/code/coq/TwoSum.v#L67) | `TwoSum.v:67` |
| Alg. 2 — 2Sum correctness | [`TwoSum_correct_loc`](https://github.com/thery/threewords/blob/main/code/coq/TwoSum.v#L465) | `TwoSum.v:465` |
| Alg. 4 — VecSum | [`vecSum`](https://github.com/thery/threewords/blob/main/code/coq/VecSum.v#L110) | `VecSum.v:110` |
| Thm. 1 — VecSum F-nonoverlap | [`vecSum_Fnonoverlap_core`](https://github.com/thery/threewords/blob/main/code/coq/VecSum.v#L668) | `VecSum.v:668` |
| Cor. 1 — VecSum (overlap) | [`vecSum_Fnonoverlap`](https://github.com/thery/threewords/blob/main/code/coq/VecSum.v#L855) | `VecSum.v:855` |
| Cor. 1 — bump reduction | [`Cor1_bump_Thm1_hyp`](https://github.com/thery/threewords/blob/main/code/coq/VecSum.v#L757) | `VecSum.v:757` |
| Alg. 5 — VSEB | [`vseb`](https://github.com/thery/threewords/blob/main/code/coq/VSEB.v#L118) | `VSEB.v:118` |
| Thm. 2 — VSEB P-nonoverlap | [`vseb_Pnonoverlap`](https://github.com/thery/threewords/blob/main/code/coq/VSEB.v#L468) | `VSEB.v:468` |
| Thm. 3 — truncation error | [`Pnonoverlap_truncate_error`](https://github.com/thery/threewords/blob/main/code/coq/Nonoverlap.v#L792) | `Nonoverlap.v:792` |
| Alg. 6 — ToTW | [`ToTW`](https://github.com/thery/threewords/blob/main/code/coq/TWSum.v#L127) | `TWSum.v:127` |
| Thm. 4 — ToTW is a TW | [`ToTW_isTW`](https://github.com/thery/threewords/blob/main/code/coq/TWSum.v#L147) | `TWSum.v:147` |
| Alg. 8 — TWSum | [`TWSum`](https://github.com/thery/threewords/blob/main/code/coq/TWSum.v#L181) | `TWSum.v:181` |
| Thm. 6 — VSEB(VecSum) P-nonov | [`vecSum_vseb_Pnonoverlap`](https://github.com/thery/threewords/blob/main/code/coq/Thm6.v#L4365) | `Thm6.v:4365` |
| Thm. 6 — TWSum is a TW | [`TWSum_isTW`](https://github.com/thery/threewords/blob/main/code/coq/addition.v#L77) | `addition.v:77` |
| error bound — 2u³+4.2u⁴ | [`TWSum_error`](https://github.com/thery/threewords/blob/main/code/coq/addition.v#L81) | `addition.v:81` |
