...
| 11 | [3Prod^acc (DW×TW)](https://github.com/thery/threewords/blob/main/code/coq/ThreeProdDW.v#L113) | [isTW](https://github.com/thery/threewords/blob/main/code/coq/ThreeProdDW.v#L143) + [Thm 8](https://github.com/thery/threewords/blob/main/code/coq/ThreeProdDW.v#L167) | 🚧 |
...
| `ThreeProdDW.v` | Algorithm 11 (3Prodᵃᶜᶜ₂,₃), the product of a **double** word by a triple word — Algorithm 9 with `x₂ = 0`. `ThreeProdDW_isTW` and `ThreeProdDW_error` (**paper Theorem 8**, relative error `≤ 10.5u³ + 39u⁴`) are **stated, proofs in progress**; the paper omits the proof of Theorem 8, recovered in `doc/thm8.md`. |
