...
COVERAGE = [
    ...
    ("3",     "2Prod",     R("TwoProd", "MULTmore.v"),
     [("correctness", R("TwoProd_correct", "MULTmore.v"))], "done"),
    ...
    ("10",    "3Prod^fast (TW×TW)", R("ThreeProdFast", "ThreeProdFast.v"),
     [("isTW", R("ThreeProdFast_isTW", "ThreeProdFast.v")),
      ("error", R("ThreeProdFast_error", "ThreeProdFast.v"))], "done"),
    ("11",    "3Prod^acc (DW×TW)", R("ThreeProdDW", "ThreeProdDW.v"),
     [("isTW", R("ThreeProdDW_isTW", "ThreeProdDW.v")),
    ...
    ("13",    "3Reci",     R("ThreeReciAux", "ThreeReci.v"),
     [("isTW", R("ThreeReci_isTW", "ThreeReci.v")),
      ("Thm 9 acc", R("ThreeReci_error", "ThreeReci.v")),
      ("Thm 9 fast", R("ThreeReciFast_error", "ThreeReci.v"))], "done"),
    ("14",    "3Div",      R("ThreeDivAux", "ThreeDiv.v"),
